...
export function PublishVersionMenu({
	...
	return (
		<div
			...
			data-testid="published-version-menu"
		>
			<Button
				type="button"
				variant="outline"
			...
			{isOpen && (
				...
				>
					<div className="mb-1 px-1 text-[10px] uppercase tracking-wide text-faint">
						Releases
					</div>

					<div
						className="max-h-56 space-y-1 overflow-y-auto"
						data-testid="published-version-list"
					>
						{versions.length === 0 ? (
