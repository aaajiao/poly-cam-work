...
export type OfficialSceneCatalogSource =
	| "bootstrap"
	| "discovered"
	| "published";

export type OfficialScenePairCompleteness =
	| "complete"
	| "missing-glb"
	| "missing-ply";

export type OfficialSceneSyncStatus =
	| "unsynced"
	| "syncing"
	| "synced"
	| "error";
...
export type IntroPresetPhase = "origin" | "expansion" | "complete";
...
export type PLYWorkerMessage = { type: "parse"; buffer: ArrayBuffer };
