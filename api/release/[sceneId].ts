...
import { readJsonBlob } from '../_lib/blobStore'
import { badRequest, jsonResponse, methodNotAllowed, notFound } from '../_lib/http'
...
export default async function handler(request: Request) {
  ...
  let version = requestedVersion ? Number.parseInt(requestedVersion, 10) : Number.NaN
