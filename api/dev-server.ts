...
const routes: Route[] = [
	{
		...
		load: () => import("./auth/login"),
	},
	{
		pattern: /^\/api\/auth\/logout\/?$/,
		load: () => import("./auth/logout"),
	},
	{
		pattern: /^\/api\/auth\/session\/?$/,
		load: () => import("./auth/session"),
	},
	{
		pattern: /^\/api\/media\/upload\/?$/,
		load: () => import("./media/upload"),
	},
	{
		pattern: /^\/api\/models\/?$/,
		load: () => import("./models/index"),
	},
	{
		pattern: /^\/api\/models\/upload\/?$/,
		load: () => import("./models/upload"),
	},
	{
		pattern: /^\/api\/draft\/[^/]+\/?$/,
	...
	{
		pattern: /^\/api\/release\/[^/]+\/?$/,
		load: () => import("./release/[sceneId]"),
	},
	{
		pattern: /^\/api\/rollback\/[^/]+\/?$/,
		load: () => import("./rollback/[sceneId]"),
	},
	{
		pattern: /^\/api\/discover\/local-models\/?$/,
		load: () => import("./discover/local-models"),
	},
];
